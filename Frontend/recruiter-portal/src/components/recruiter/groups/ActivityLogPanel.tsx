...
export function ActivityLogPanel({ groupId, groupName, onClose, isInline = false }: ActivityLogPanelProps) {
    ...
    const panelContent = (
        <div className={`bg-white ${isInline ? 'rounded-[16px] border border-[#e5e7eb] w-full' : 'rounded-[20px] shadow-2xl w-full max-w-3xl max-h-[88vh]'} flex flex-col overflow-hidden`}>
            {/* Header */}

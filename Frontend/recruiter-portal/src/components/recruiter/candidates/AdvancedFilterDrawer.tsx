...
interface AdvancedFilterDrawerProps {
  ...
  activeFilters?: any;
  hidePostProcessFilters?: boolean;
}

export function AdvancedFilterDrawer({ onClose, onApply, activeFilters = {}, hidePostProcessFilters = false }: AdvancedFilterDrawerProps) {
              ...
              <div className="flex flex-wrap gap-2">
                {languageOptions.map(lang => (
                  <button
                    ...
                    className={`h-[32px] px-[12px] rounded-[6px] font-['Arimo',sans-serif] text-[13px] transition-colors ${filters.languages.includes(lang)
              ...
              <div className="flex flex-wrap gap-2">
                {degreeOptions.map(deg => (
                  <button
                    ...
                    className={`h-[32px] px-[12px] rounded-[6px] font-['Arimo',sans-serif] text-[13px] transition-colors ${filters.degree.includes(deg)
                      ? 'bg-[#6366f1] text-white'
                      : 'bg-[#f3f4f6] text-[#374151] hover:bg-[#e5e7eb]'
                      }`}
                  >
              ...
              <div className="flex flex-wrap gap-2">
                {seniorityOptions.map(sen => (
                  <button
                    ...
                    className={`h-[32px] px-[12px] rounded-[6px] font-['Arimo',sans-serif] text-[13px] transition-colors ${filters.seniority.includes(sen)
                      ? 'bg-[#6366f1] text-white'
                      : 'bg-[#f3f4f6] text-[#374151] hover:bg-[#e5e7eb]'
                      }`}
                  >
              ...
              <div className="flex flex-wrap gap-2">
                {employmentTypeOptions.map(type => (
                  <button
                    ...
                    className={`h-[32px] px-[12px] rounded-[6px] font-['Arimo',sans-serif] text-[13px] transition-colors ${filters.employmentType.includes(type)
                      ? 'bg-[#6366f1] text-white'
                      : 'bg-[#f3f4f6] text-[#374151] hover:bg-[#e5e7eb]'
                      }`}
                  >
              ...
              <div className="flex flex-wrap gap-2 mb-3">
                {techStackOptions.map(tech => (
                  <button
                    ...
                    className={`h-[32px] px-[12px] rounded-[6px] font-['Arimo',sans-serif] text-[13px] transition-colors ${filters.techStack.includes(tech)
                ...
                {filters.techStack.filter((t: string) => !techStackOptions.includes(t)).map((tech: string) => (
                  <button
                    key={tech}
                    onClick={() => setFilters({ ...filters, techStack: filters.techStack.filter((t: string) => t !== tech) })}
            ...
            <div>
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`flex-1 h-[36px] rounded-[6px] font-['Arimo',sans-serif] text-[13px] transition-colors ${filters.hasGitHub === true
                    ? 'bg-[#6366f1] text-white'
                    : 'bg-[#f3f4f6] text-[#374151] hover:bg-[#e5e7eb]'
                    }`}
                >
                ...
                <button
                  ...
                  className={`flex-1 h-[36px] rounded-[6px] font-['Arimo',sans-serif] text-[13px] transition-colors ${filters.hasGitHub === false
                    ? 'bg-[#6366f1] text-white'
                    : 'bg-[#f3f4f6] text-[#374151] hover:bg-[#e5e7eb]'
                    }`}
                >
                ...
                <button
                  ...
                  className={`flex-1 h-[36px] rounded-[6px] font-['Arimo',sans-serif] text-[13px] transition-colors ${filters.hasGitHub === null
                    ? 'bg-[#6366f1] text-white'
                    : 'bg-[#f3f4f6] text-[#374151] hover:bg-[#e5e7eb]'
                    }`}
                >
                ...
                <div className="flex flex-wrap gap-2">
                  {assessmentStatusOptions.map(status => (
                    <button
                      ...
                      className={`h-[32px] px-[12px] rounded-[6px] font-['Arimo',sans-serif] text-[13px] transition-colors ${filters.assessmentStatus.includes(status)
                        ? 'bg-[#6366f1] text-white'
                        : 'bg-[#f3f4f6] text-[#374151] hover:bg-[#e5e7eb]'
                        }`}
                    >
                ...
                <div className="flex flex-wrap gap-2">
                  {integrityFlagOptions.map(flag => (
                    <button
                      ...
                      className={`h-[32px] px-[12px] rounded-[6px] font-['Arimo',sans-serif] text-[13px] transition-colors ${filters.integrityFlag.includes(flag)
                ...
                <div className="flex flex-wrap gap-2">
                  {responseSpeedOptions.map(speed => (
                    <button
                      ...
                      className={`h-[32px] px-[12px] rounded-[6px] font-['Arimo',sans-serif] text-[13px] transition-colors ${filters.responseSpeed.includes(speed)
                        ? 'bg-[#6366f1] text-white'
                        : 'bg-[#f3f4f6] text-[#374151] hover:bg-[#e5e7eb]'
                        }`}
                    >

...
interface RecruiterForgotPasswordPageProps {
    onBack: () => void;
}

export function RecruiterForgotPasswordPage({ onBack }: RecruiterForgotPasswordPageProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setError(null);
        try {
            await api.auth.organizationUserForgotPassword(email);
            setIsSubmitted(true);
        } catch (err: any) {

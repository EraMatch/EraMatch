...
interface RecruiterResetPasswordPageProps {
    onBack: () => void;
}

export function RecruiterResetPasswordPage({ onBack }: RecruiterResetPasswordPageProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setError(null);
        try {
            await api.auth.organizationUserResetPassword(token, password);
            setIsSubmitted(true);
        } catch (err: any) {
                        ...
                        {!isSubmitted ? (
                            <>
                                ...
                                <p className="text-gray-600 mb-8">
                                    Set a new, secure password for your recruiter account.
                                </p>

import svgPaths from "./svg-ouztpsqwzj";
...
function Heading() {
  return (
    <div className="h-[40px] relative shrink-0 w-[125.422px]" data-name="Heading 1">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[40px] relative w-[125.422px]">
        <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[40px] left-0 text-[36px] text-black text-nowrap top-[-3px] whitespace-pre">Projects</p>
      </div>
    </div>
  );
}
      ...
      <div className="absolute bottom-1/2 left-[20.83%] right-[20.83%] top-1/2" data-name="Vector">
        <div className="absolute inset-[-0.83px_-7.14%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 2">
            <path d="M0.833333 0.833333H12.5" id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-[20.83%] left-1/2 right-1/2 top-[20.83%]" data-name="Vector">
        <div className="absolute inset-[-7.14%_-0.83px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2 14">
            <path d="M0.833333 0.833333V12.5" id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
    </div>
...
function Button2() {
  return (
    <div className="absolute box-border content-stretch flex flex-col items-start left-0 pb-0 pt-[8px] px-[8px] rounded-[10px] size-[36px] top-[3px]" data-name="Button">
      <Icon1 />
    </div>
  );
}
      ...
      <div className="absolute inset-[12.5%_8.34%_8.33%_8.33%]" data-name="Vector">
        <div className="absolute inset-[-5.26%_-5%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19 18">
            <path d={svgPaths.p1add3400} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
    </div>
...
function SlotClone() {
  return (
    <div className="absolute box-border content-stretch flex flex-col items-start left-[309.5px] pb-0 pt-[8px] px-[8px] rounded-[10px] size-[36px] top-[3px]" data-name="SlotClone">
      <Icon2 />
    </div>
  );
}
  ...
  return (
    <div className="h-[20px] overflow-clip relative shrink-0 w-full" data-name="Icon">
      <div className="absolute inset-[66.67%_12.5%_16.67%_54.17%]" data-name="Vector">
        <div className="absolute inset-[-25%_-12.5%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9 5">
            <path d={svgPaths.p28b38500} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[16.67%_29.17%_16.67%_70.83%]" data-name="Vector">
        <div className="absolute inset-[-6.25%_-0.83px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2 15">
            <path d="M0.833333 14.1667V0.833333" id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[16.67%_54.17%_66.67%_12.5%]" data-name="Vector">
        <div className="absolute inset-[-25%_-12.5%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9 5">
            <path d={svgPaths.p24ead0c0} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[16.67%_70.83%_16.67%_29.17%]" data-name="Vector">
        <div className="absolute inset-[-6.25%_-0.83px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2 15">
            <path d="M0.833333 0.833333V14.1667" id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
    </div>
...
function SlotClone1() {
  return (
    <div className="absolute box-border content-stretch flex flex-col items-start left-[361.5px] pb-0 pt-[8px] px-[8px] rounded-[10px] size-[36px] top-[3px]" data-name="SlotClone">
      <Icon3 />
    </div>
  );
}
...
function TextInput() {
  return (
    <div className="absolute bg-white h-[42px] left-0 rounded-[10px] top-0 w-[241.5px]" data-name="Text Input">
      <div className="box-border content-stretch flex h-[42px] items-center overflow-clip pl-[40px] pr-[16px] py-[8px] relative rounded-[inherit] w-[241.5px]">
        <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#aaaaaa] text-[16px] text-nowrap whitespace-pre">Search</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#edf0f8] border-solid inset-0 pointer-events-none rounded-[10px]" />
    </div>
  );
}
  ...
  return (
    <div className="absolute left-[12px] size-[20px] top-[11px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d="M17.5 17.5L13.8834 13.8833" id="Vector" stroke="var(--stroke-0, #AAAAAA)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.pcddfd00} id="Vector_2" stroke="var(--stroke-0, #AAAAAA)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Container1() {
  return (
    <div className="absolute h-[42px] left-[52px] top-0 w-[241.5px]" data-name="Container">
      <TextInput />
      <Icon4 />
    </div>
  );
...
function Container2() {
  return (
    <div className="h-[42px] relative shrink-0 w-[397.5px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[42px] relative w-[397.5px]">
        <Button2 />
        <SlotClone />
        <SlotClone1 />
        <Container1 />
...
function Text2() {
  return (
    <div className="h-[24px] relative shrink-0 w-[101.758px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[101.758px]">
...
function Container4() {
  return (
    <div className="h-[30px] relative shrink-0 w-[328.531px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[32px] h-[30px] items-center relative w-[328.531px]">
        <Text />
        <Text1 />
        <Text2 />
      </div>
      ...
      <div className="absolute inset-[8.33%_8.33%_8.34%_8.33%]" data-name="Vector">
        <div className="absolute inset-[-5%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 15">
            <path d={svgPaths.p4290a20} id="Vector" stroke="var(--stroke-0, #9F9F9F)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[20.83%_20.83%_62.5%_62.5%]" data-name="Vector">
        <div className="absolute inset-[-25%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4 4">
            <path d={svgPaths.p17db7800} id="Vector" stroke="var(--stroke-0, #9F9F9F)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          </svg>
        </div>
      </div>
    </div>
...
function Button4() {
  return (
    <div className="basis-0 bg-[#4834ab] grow h-[40px] min-h-px min-w-px relative rounded-[10px] shrink-0" data-name="Button">
...
function Container5() {
  return (
    <div className="h-[40px] relative shrink-0 w-[125.742px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[12px] h-[40px] items-center relative w-[125.742px]">
        <Button3 />
        <Button4 />
      </div>
    </div>
...
function Container6() {
  return (
    <div className="bg-[#f7fafe] h-[88px] relative rounded-[14px] shrink-0 w-full" data-name="Container">
      <div className="flex flex-row items-center size-full">
...
function Text5() {
  return (
    <div className="h-[24px] relative shrink-0 w-[93.133px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[93.133px]">
...
function Container7() {
  return (
    <div className="h-[30px] relative shrink-0 w-[313.117px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[32px] h-[30px] items-center relative w-[313.117px]">
        <Text3 />
        <Text4 />
        <Text5 />
      </div>
...
function ProjectsPage() {
  return (
    <div className="h-[1058px] relative shrink-0 w-full" data-name="ProjectsPage">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[32px] h-[1058px] items-start pb-0 pt-[32px] px-[32px] relative w-full">
          <Container3 />
          <Container25 />
        </div>
      </div>
...
function App() {
  return (
    <div className="absolute bg-[#edf0f8] box-border content-stretch flex flex-col h-[1148px] items-start left-0 pl-[96px] pr-0 py-0 top-0 w-[1528px]" data-name="App">
      <Header />
      <ProjectsPage />
    </div>
  );

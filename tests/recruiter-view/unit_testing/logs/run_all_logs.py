"""
Master runner for ALL EraMatch recruiter view assurance log scripts.
Executes every log module, collects results, and generates a single
consolidated HTML report.

Run: python tests/recruiter-view/unit_testing/logs/run_all_logs.py
"""
import sys
import os
import json
...
# Add logs/ parent to path so log_utils is importable from every log script
...
LOG_MODULES = [
    ("log_recruiter_login",          "Recruiter Login"),
    ("log_recruiter_projects",       "Recruiter Projects"),
    ("log_recruiter_positions",      "Recruiter Positions"),
    ("log_recruiter_candidates",     "Recruiter Candidates"),
    ("log_recruiter_groups",         "Recruiter Group Management"),
    ("log_recruiter_settings",       "Recruiter Settings"),
    ("log_recruiter_analytics",      "Recruiter Analytics"),
    ("log_recruiter_assessments",    "Recruiter Assessments"),
    ("log_recruiter_question_bank",  "Recruiter Question Bank"),
]
...
<head>
    <meta charset="UTF-8">
    <title>EraMatch Recruiter — Combined Assurance Report</title>
    <style>
...
<body>
<div class="card">
    <h1>🛡️ EraMatch Recruiter — Combined Assurance Report</h1>
    <div class="meta">
...
def main():
    print("\n" + "=" * 70)
    print("  🛡️  EraMatch Recruiter View — Full Assurance Suite")

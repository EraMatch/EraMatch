...
from routers import llm, custom, transcribe, evaluate, question_import, anomaly_detection, github_analysis, proctoring_beta
...
app.include_router(proctoring_beta.router, prefix="/beta/proctoring", tags=["Proctoring Beta"])
